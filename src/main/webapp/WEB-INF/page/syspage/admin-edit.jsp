...
<article class="cl pd-20">
    <form action="${pageContext.request.contextPath}/config/updateUser" method="post" class="form form-horizontal"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="password" class="input-text" autocomplete="off" value="" placeholder="不填写则不修改"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" autocomplete="off" value="${user.status}" placeholder="这里填写下状态码，1：启用，0：停用" id="status" name="status">
            </div>
        </div>
        <div class="row cl">
