                ...
                <c:forEach items="${list}" var="category">
                    <tr class="text-c">
                        ...
                        <td><a title="编辑" href="javascript:;" onclick="admin_category_edit('分类编辑','editCategory?id=${category.id}','1','','310')" class="ml-5" style="text-decoration:none">
                            <i class="Hui-iconfont">&#xe6df;</i></a> <a  deleteLink="true" title="删除" href="${pageContext.request.contextPath}/category/delCategory?id=${category.id}" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
